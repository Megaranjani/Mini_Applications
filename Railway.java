...
public class Railway {
    private static final String train_name = "MADRAS Express";
    private static final String train_num = "CS1012";
    ...
    private static void book_home() {
        System.out.println("\t\t\t\t***********Welcome to MADRAS Train Booking********");
    ...
    private static void user_signup() {
        ...
        System.out.println("Remember your log in credentials!!!");
        user_id++;
    ...
    private static void orgUser() {
        ...
        System.out.println("4.User Wallet");
    ...
    private static void confirm_seat(int no, int stop, int arr) {
        ...
        lb1: for (int j = 0; j < 3; j++) {
            ...
            if (sum == 0) {
                ...
                System.out.println(
                        " Seat Allowcated for User " + user_list.get(index).u_name);
                System.out.println("Your Seat Number is " + j);
                System.out.println("Your Ticket Number is:" + tic_no);

                System.out.println("Amount for this ticket is " + curr_amt + " Deducted from your Wallet");
                flag = false;
    ...
    private static void wallet() {
        System.out.println("Your Wallet is " + user_list.get(index).u_amt);
        System.out.println("\t\t\tPress enter to continue...");
        scan.nextLine();
        String s = scan.nextLine();
        System.out.print("\033[H\033[2J");
    ...
    private static void userList() {
        user_list.add(new users("Mega", "1234", "9958716212", 10000, 93));
        user_list.add(new users("Meena", "4567", "9347265198", 9000, 92));
        user_list.add(new users("Neha", "7896", "8316545412", 3000, 90));
    }
