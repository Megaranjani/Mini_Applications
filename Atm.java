...
public class Atm {
    ...
    static void createuser() {
        user[0] = new users("Mickey", "1331", 31000.00, "sbi679", "12345", "uco", "", 0);
        user[1] = new users("Rose", "1234", 10000.00, "ib741", "99999", "rbi", "", 0);
        user[2] = new users("Karthi", "5678", 60000.00, "can083", "88888", "canara", "", 0);
        user[3] = new users("Tannya", "4321", 20000.00, "and023", "77777", "uco", "", 0);
        user[4] = new users("Maga", "7896", 80000.00, "unb777", "66666", "uco", "", 0);
    }
        ...
        do {
            ...
            switch (ch) {
                case 1:
                    ...
                    System.out.print("\033[H\033[2J");
                    System.out.flush();
                    if (adminId.equals("MEGA") && pswd.equals("12345")) {
                        int n = 0;
                        do {
