...
public class Amazon {
    ...
    private static void admin() {
        ...
        System.out.flush();
        if (adminId.equals("mega") && pswd.equals("1234")) {
            amazonadmin();
        } else {
...
class merchands extends Amazon {
    int merchandId;
    String merchandname;
